...
[EPUBCheck 4.2.1](https://github.com/w3c/epubcheck/releases/tag/v4.2.1) is the latest production-ready release, to be used to validate both EPUB 2 and 3 files. EPUB 3 publications are checked against the EPUB 3.2 family of specifications.
