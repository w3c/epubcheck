...
[EPUBCheck 4.2.0-alpha-1](https://github.com/w3c/epubcheck/releases/tag/v4.2.0-alpha-1) is the latest preview release of the forthcoming 4.2.0 version, to be used for testing only. It features early support for the EPUB 3.2 family of specifications.
